    ...
    <div style={containerStyle(isDark, theme)}>
      <div style={panelStyle(isDark, theme)}>
        <div style={headerStyle}>
          ...
          <h2 style={titleStyle(theme)}>Create Your Account</h2>
          <p style={subtitleStyle(theme)}>Join thousands of students preparing for placements</p>
        </div>
        ...
        <div style={formStyle}>
          ...
          <div style={termsStyle(theme)}>
            <label style={checkboxLabelStyle}>
              ...
              />
              <span>
                I agree to the <a href="#" style={linkStyle(theme)}>Terms & Conditions</a>
              </span>
            </label>
          </div>
        ...
        <div style={footerStyle}>
          <p style={footerTextStyle(theme)}>
            ...
            <span onClick={() => navigate("/login")} style={highlightLinkStyle(theme)}>
              Sign in
            </span>
          </p>
        </div>
